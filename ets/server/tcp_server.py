...
alldata = dict()
alldata['1']=dict(nomor=1, nama="Rick Riordan", posisi="Fav 1")
alldata['2']=dict(nomor=2, nama="Yonezawa Honobu", posisi="Fav 2")
alldata['3']=dict(nomor=3, nama="JK Rowling", posisi="Fav 3")
alldata['4']=dict(nomor=4, nama="Brandon Sanderson", posisi="Fav 4")
alldata['5']=dict(nomor=5, nama="Victoria Aveyard", posisi="Fav 5")
alldata['6']=dict(nomor=6, nama="Leigh Bardugo", posisi="Fav 6")
